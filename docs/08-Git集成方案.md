...
每个项目配置一条凭证，支持 HTTP（PAT/OAuth）和 SSH 两种认证方式：
...
| 方式 | 命令 / 端点 |
|------|------------|
| CLI | `flowcode project git-connect --provider github --token ghp_xxx` |
| API | `POST /api/v1/projects/:pid/git/connect` |
